...
import { FavoritesHeroesContext } from "../context/FavoriteHeroes";
...
export const HeroGridCard = ({ hero }: Props) => {
  ...
  const { isFavorite, toggleFavorites } = use(FavoritesHeroesContext);
  const handleClick = () => {
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium">Fy</span>
            </div>
            <Progress
